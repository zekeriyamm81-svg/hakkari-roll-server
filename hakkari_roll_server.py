...
def pub(u,viewer=None):return dict(id=u['id'],username=u['username'],display_name=u['display_name'],bio=u['bio'] or '',profile_photo=u['profile_photo'],role=u['role'],vip=bool(u['vip']) if 'vip' in u.keys() else False,email_verified=bool(u['email_verified']) if 'email_verified' in u.keys() else True,email=u['email'] if 'email' in u.keys() else '',is_me=u['id']==viewer)
