...
def admin_announcement_delete(aid):
 a=me();c=db();c.execute('delete from announcements where id=?',(aid,));audit(c,a['id'],'Duyuru silindi','announcement',aid,'');c.commit();c.close();return jsonify(ok=True,message='Duyuru silindi.')
